      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="glass-panel p-8 mb-12">
          ...
          >
            ...
            <h1 className="text-5xl font-bold mb-4 neon-glow">Crewverse.io</h1>
            <p className="text-xl text-gray-400 mb-8">
              Unlock your creative potential with AI-powered content tools and endless career opportunities.
            </p>
            <Link
              to="/register"
